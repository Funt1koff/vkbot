...
@ApplicationScoped
@Slf4j
public class MessageAllowProcessor extends AbstractEventProcessor {

    private final UserService userService;

    @Inject
    public MessageAllowProcessor(@All List<BotCommand> botCommands,
                                 UserService userService) {
        super(botCommands);
        this.userService = userService;
    }

    public MessageAllowProcessor() {
        super(null);
    ...
    public void process(VkCallback callBack) {
        ...
        if (user == null) {
            ...
            user.setSendingMessagesAllowed(true);
        }
